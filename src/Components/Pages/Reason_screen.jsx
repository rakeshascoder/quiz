...
const Reason_screen = () => {
  ...
  return (
    <div className="px-[20px] md:px-[50px]">
      <div className="xl:h-[calc(100vh-71px)] pb-10">
        ...
        <div className="sm:max-w-[343px]  text-center mx-auto flex flex-col  items-center   ">
          ...
          <div className="flex flex-col mb-10 gap-[19px]" >
            {Reason_screen_data.map((item) => {
              return (
                <div key={item.id} className="shadow-[0px_8px_16px_rgba(47,60,51,0.05)] hover:border hover:border-[#D6B588] border border-transparent transition-all hover:shadow-[0_0_0_4px_rgba(47,60,51,0.05)] rounded-[26px]"
                >
                  <Link to={""}>
                    <div className={`max-w-[343px] px-[36px]  flex items-center justify-center bg-white h-[72px]  shadow-[0_8px_16px_rgba(47, 60, 51, 0.05)]   rounded-[26px]`}>
